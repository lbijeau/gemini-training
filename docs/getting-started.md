...
*   Explore the **[docs/modules/](./modules/)** directory for conceptual explanations of Gemini CLI features.
*   Try the hands-on **[docs/exercises/](./exercises/)** to practice your skills.
